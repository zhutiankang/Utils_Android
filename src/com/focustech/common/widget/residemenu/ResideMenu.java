package com.focustech.common.widget.residemenu;
...
public class ResideMenu extends FrameLayout
{
	...
	public void setShadowVisible(boolean isVisible)
	{
		...
		else imageViewShadow.setImageBitmap(null);
	}
	...
	public void setMenuItems(List<ResideMenuItem> menuItems, int direction)
	{
		if (direction == DIRECTION_LEFT)
			this.leftMenuItems = menuItems;
		else this.rightMenuItems = menuItems;
		rebuildMenu();
	}
	...
	public void openMenu(int direction)
	{
		...
		AnimatorSet scaleDown_shadow = buildScaleDownAnimation(imageViewShadow, mScaleValue + shadowAdjustScaleX,
	...
	private void setScaleDirectionByRawX(float currentRawX)
	{
		...
		else setScaleDirection(DIRECTION_LEFT);
	}
