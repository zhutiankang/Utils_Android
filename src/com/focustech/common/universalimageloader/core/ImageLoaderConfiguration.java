...
import com.focustech.common.universalimageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.focustech.common.universalimageloader.core.assist.FlushedInputStream;
...
import com.focustech.common.universalimageloader.core.process.BitmapProcessor;
import com.focustech.common.universalimageloader.utils.L;
import com.focustech.common.universalimageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	...
	private static class NetworkDeniedImageDownloader implements ImageDownloader {
		...
		@Override
		public InputStream getStream(String imageUri, String[] propertyKeys, String[] propertyValues, Object extra)
				throws IOException
		{
			switch (Scheme.ofUri(imageUri))
			{
			...
			case HTTPS:
				throw new IllegalStateException();
			default:
				return wrappedDownloader.getStream(imageUri, propertyKeys, propertyValues, extra);
			}
		}
	}
	...
	private static class SlowNetworkImageDownloader implements ImageDownloader {
		...
		public InputStream getStream(String imageUri, String[] propertyKeys, String[] propertyValues, Object extra)
				throws IOException
		{
			InputStream imageStream = wrappedDownloader.getStream(imageUri, propertyKeys, propertyValues, extra);
			switch (Scheme.ofUri(imageUri))
			{
			case HTTP:
			case HTTPS:
